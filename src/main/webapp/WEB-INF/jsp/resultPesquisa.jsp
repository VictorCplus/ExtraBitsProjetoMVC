        ...
        <header class="p-3 bg-dark text-white">
            <div class="container">
                ...
                <div class="form-group order-lg-first">
                    <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search" action="/extrabits/pesquisa" method="post" name="pesquisa">
                        <input type="search" class="form-control form-control-dark text-white bg-dark"
                               placeholder="Pesquise por uma categoria ou produto..." aria-label="Search" name="pesquisa">
                    </form>
                </div>
            </div>
        </header>
